...
# 4. 경로 설정
try:
    ROOT_DIR = Path(__file__).resolve().parent  # backend/pipelines
except NameError:
    ROOT_DIR = Path(os.getcwd())

# 🔹 gloss 폴더 사용
DATA_DIR = ROOT_DIR / "gloss"

OUT_DIR = ROOT_DIR / "snapshots14"

GLOSS_DICT_PATH = DATA_DIR / "gloss_dictionary_MOCK.csv"
RULES_JSON_PATH = DATA_DIR / "rules.json"
GLOSS_MP4_DIR = Path(r"C:\Users\user\Desktop\2025-2-DSCD-KKHH-04-git\backend\pipelines\gloss_mp4")
