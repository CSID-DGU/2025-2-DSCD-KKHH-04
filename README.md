...
* **기존 대안의 한계:** 화상 수어 통역은 인력 부족과 대기 시간 문제가 있고, 아바타 번역 기술은 표정과 비언어적 표현이 부족하여 감정이나 뉘앙스 전달에 실패하곤 합니다.
* **현장의 니즈:** 대리인 동반 시 발생하는 개인정보 노출 우려를 없애고, 청각장애인이 스스로 자산을 관리할 수 있는 **주체적인 상담 환경**이 절실했습니다.
